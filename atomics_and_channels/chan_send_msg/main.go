...
func main() {
	...
	// Своевременное закрытие с помощью функции close() канала горутиной,
	// ответственной за посылку сообщений в неё, позволит так же своевременно
	// выйти из цикла, дабы не привести к deadlock
}
